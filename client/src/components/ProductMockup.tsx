...
const MiniBar = ({ width = "72%", coral = false }: { width?: string; coral?: boolean }) => (
  <span className={`mini-bar ${coral ? "is-coral" : ""}`} style={{ width }} />
);
  ...
  return (
    <div className="mockup-layout hris-layout">
      <aside className="mockup-sidebar">
        ...
        <div className="nav-lines"><MiniBar width="66%" coral /><MiniBar width="52%" /><MiniBar width="71%" /><MiniBar width="45%" /></div>
...
function RemunerationInterface() {
  return (
    <div className="mockup-layout remuneration-layout">
      <aside className="mockup-sidebar"><div className="mini-brand"><span className="brand-box" /> <MiniBar width="54%" /></div><div className="nav-lines"><MiniBar width="54%" /><MiniBar width="70%" coral /><MiniBar width="49%" /><MiniBar width="64%" /></div><div className="sidebar-note"><MiniBar width="75%" /><MiniBar width="51%" /></div></aside>
...
function TicketingInterface() {
  ...
  return (
    <div className="mockup-layout ticketing-layout">
      <aside className="mockup-sidebar"><div className="mini-brand"><span className="brand-box" /> <MiniBar width="54%" /></div><div className="nav-lines"><MiniBar width="60%" coral /><MiniBar width="48%" /><MiniBar width="69%" /><MiniBar width="40%" /></div><div className="sidebar-profile"><span className="avatar">TS</span><div><MiniBar width="59%" /><MiniBar width="38%" /></div></div></aside>
